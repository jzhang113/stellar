...
<div class="panel-display webb-flipped clearfix <?php if (!empty($class)) { print $class; } ?>" <?php if (!empty($css_id)) { print "id=\"$css_id\""; } ?>>
  ...
  <div class="webb-flipped-container webb-flipped-column-content clearfix">
    ...
    <div class="webb-flipped-content-container span8-1">
      <div class="webb-flipped-content-container-inner">
        ...
        <div class="webb-flipped-content-container-column-container clearfix">
          <div class="webb-flipped-column-content-region webb-flipped-content-column1 webb-flipped-column panel-panel span6-1">
          ...
          <div class="webb-flipped-column-content-region webb-flipped-content-column2 webb-flipped-column panel-panel span6-7">
    ...
    <div class="webb-flipped-sidebar webb-flipped-column-content-region webb-flipped-column panel-panel span4-9">
