...
<div class="panel-display bartlett clearfix <?php if (!empty($class)) { print $class; } ?>" <?php if (!empty($css_id)) { print "id=\"$css_id\""; } ?>>
  ...
  <div class="bartlett-sidebar bartlett-column-content-region bartlett-column bartlett-container panel-panel span4-1">
  ...
  <div class="bartlett-content-container bartlett-container span8-5">
    ...
    <div class="bartlett-content-container-column-container clearfix">
      <div class="bartlett-column-content-region bartlett-content-column1 bartlett-column panel-panel span6-1">
      ...
      <div class="bartlett-column-content-region bartlett-content-column2 bartlett-column panel-panel span6-7">
