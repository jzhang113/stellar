...
<div class="panel-display its-front clearfix <?php if (!empty($class)) { print $class; } ?>" <?php if (!empty($css_id)) { print "id=\"$css_id\""; } ?>>
  ...
  <div class="its-front-container its-front-column-content its-front-column-content-row1 clearfix">
    <div class="its-front-column-content-region its-front-column1 panel-panel span9-1">
      <div class="its-front-column-content-region-inner its-front-column1-inner panel-panel-inner">
        <?php print $content['column1']; ?>
      </div>
    </div>
    <div class="its-front-column-content-region its-front-column2 panel-panel span3-10">
  ...
  <div class="its-front-container its-front-secondary-column-content its-front-column-content-row2 clearfix">
    <div class="its-front-secondary-column-content-region its-front-secondary-column1 panel-panel span3-1">
    ...
    <div class="its-front-secondary-column-content-region its-front-secondary-column2 panel-panel span3-4">
    ...
    <div class="its-front-secondary-column-content-region its-front-secondary-column3 panel-panel span3-7">
	...
	<div class="its-front-secondary-column-content-region its-front-secondary-column4 panel-panel span3-10">
