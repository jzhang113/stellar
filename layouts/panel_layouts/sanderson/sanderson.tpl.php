...
<div class="panel-display sanderson clearfix <?php if (!empty($class)) { print $class; } ?>" <?php if (!empty($css_id)) { print "id=\"$css_id\""; } ?>>
  ...
  <div class="sanderson-container sanderson-column-content sanderson-column-content-row1 clearfix">
    <div class="sanderson-column-content-region sanderson-column1 panel-panel span6-1">
      <div class="sanderson-column-content-region-inner sanderson-column1-inner panel-panel-inner">
        <?php print $content['column1']; ?>
      </div>
    </div>
    <div class="sanderson-column-content-region sanderson-column2 panel-panel span6-7">
  ...
  <div class="sanderson-container sanderson-secondary-column-content sanderson-column-content-row2 clearfix">
    <div class="sanderson-secondary-column-content-region sanderson-secondary-column1 panel-panel span4-1">
    ...
    <div class="sanderson-secondary-column-content-region sanderson-secondary-column2 panel-panel span4-5">
    ...
    <div class="sanderson-secondary-column-content-region sanderson-secondary-column3 panel-panel span4-9">
